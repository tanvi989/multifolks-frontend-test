        ...
        <main>
          <Routes>
            ...
            <Route element={<Layout />}>
              ...
              <Route path="/reports" element={<div className="p-8 text-center text-gray-500 font-bold text-xl">Reports Module Coming Soon</div>} />

              {/* Placeholder routes for sidebar links */}
              <Route path="/lens" element={<div className="p-8 text-center text-gray-500 font-bold text-xl">Lens Inventory</div>} />
              <Route path="/claim-report" element={<div className="p-8 text-center text-gray-500 font-bold text-xl">Claim Report Module Coming Soon</div>} />
            </Route>
