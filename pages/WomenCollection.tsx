    ...
    <div className="min-h-screen bg-white font-sans relative pb-20 lg:pb-0 pt-[120px]">
      ...
      <div className="max-w-[1600px] mx-auto px-0 md:px-8 py-4 lg:py-8 flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 relative">
          ...
          >
            {/* Main Filter Bar */}
            <div className="flex flex-wrap items-start gap-3 mb-2 pb-4 relative">
              {/* Size Dropdown */}
              <div>
                <button
                  onClick={() =>
                  ...
                  className={`px-4 py-2 text-sm font-medium rounded-full flex items-center gap-2 transition-colors ${activeFilterCategory === "Size" ||
              ...
              <div>
                <button
                  ...
                  className={`px-4 py-2 text-sm font-medium rounded-full flex items-center gap-2 transition-colors ${activeFilterCategory === "Brand" ||
              ...
              <div>
                <button
                  ...
                  className={`px-4 py-2 text-sm font-medium rounded-full flex items-center gap-2 transition-colors ${activeFilterCategory === "Styles" ||
              ...
              <div className="ml-auto flex items-center gap-6">
                ...
                {/* <div className="flex items-center gap-3">
                  ...
                  <div
                    ...
                    className={`w-12 h-6 rounded-full p-1 transition-all duration-300 flex items-center cursor-pointer ${fitEnabled
                ...
                <div className="relative" ref={sortRef}>
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-[#333] hover:text-[#1F1F1F] transition-colors"
                  >
                    <span>Sort By</span>
                    <svg
                      width="10"
