...
const SelectPrescriptionType: React.FC = () => {
  ...
  const [selectedType, setSelectedType] = useState<"progressive" | "bifocal" | null>(
    null
  );
  ...
  return (
    <div className="min-h-screen bg-[#F3F0E7] font-sans py-8 px-4 md:px-8 mt-0">
      ...
      <div className="max-w-[1000px] mx-auto relative mt-4 md:mt-6">
        ...
        {/* Main Content Area */}
        <div className={`grid gap-5 mb-12 max-w-[900px] mx-auto ${expanded ? "grid-cols-1" : "grid-cols-1 md:grid-cols-2"}`}>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="33" viewBox="0 0 53 47" fill="none">
                      ...
                      <path d="M10.8542 26.4248C6.92456 25.5703 4.7957 24.9909 1.11804 23.6431C1.34289 26.7829 1.9846 28.5435 3.62162 31.7102C5.96719 36.2336 7.40183 38.1458 10.0198 40.6118C9.4408 38.9285 9.21751 37.6541 9.4633 35.6046L11.4105 30.8756C12.3944 28.4821 12.6067 27.3185 10.8542 26.4248Z" fill="#F3C507" stroke="#E94D37" strokeWidth="0.5" strokeDasharray="2 2"></path>
          ...
          {/* Bifocal Lenses Section - Only when not expanded */}
          {!expanded && (
            <div
              className={`flex flex-col w-full 
                rounded-3xl p-6 border cursor-pointer 
